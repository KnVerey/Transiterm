...
Rails.application.config.sorcery.submodules = [:remember_me, :user_activation, :brute_force_protection, :reset_password, :activity_logging]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.user_config do |user|
    ...
    # Default: `60 * 60`
    #
    user.login_lock_time_period = 60*60*3
